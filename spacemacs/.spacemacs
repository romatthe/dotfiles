...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(doom-city-lights-theme-)
...
you should place your code here."
  ...
  ;; Add `hlint' as a checker after `intero' to flycheck
  ...
  ;; Make TABs behave like they would normally do in their respective major-mode
  ;; when making use of BEGIN_SRC in Org-mode
